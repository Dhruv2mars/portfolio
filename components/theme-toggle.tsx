...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex size-8 touch-manipulation items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50"
    >
